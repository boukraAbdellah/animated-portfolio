...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm("service_a98dx6m", "template_bw84fxg", form.current, {
        publicKey: "eMlmoN6xBRTd83l0U",
      })
      .then(
        () => {
          console.log("SUCCESS!");
    ...
    >
      <motion.div className="textContainer" variants={variants}>
        ...
        <motion.div className="item" variants={variants}>
          <h3>Mail</h3>
          <span>abdou.dev@gmail.com</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h3>Adress</h3>
          <span>Hammam Bouhadjar, Algeria</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h3>Phone</h3>
          <span>+213669627625</span>
        </motion.div>
      </motion.div>
      <div className="formContainer">
        <motion.div
          className="phoneSvg"
          initial={{ opacity: 1 }}
          whileInView={{ opacity: 0, transition: { duration: 1, delay: 3 } }}
        >
          <svg
            fill="none"
            width="450px"
          ...
          >
            <motion.path
              ...
              whileInView={{ pathLength: 1, pathOffset: 0, transition: { duration: 2, delay: 0 } }}
